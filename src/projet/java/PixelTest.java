...
class PixelTest {
    ...
    void testGetColor() {
        Pixel pixel = new Pixel(10, 20, -14506108);
        assertEquals(-14506108, pixel.getColor()); //On vérifie qu'il retourne la bonne couleur.
    }
    ...
    void testGetAnglesPixel() {
        ...
        assertEquals(0, angles.size()); //On vérifie que la taille de l'ArrayList est correct égal à 0.
    }
    ...
    void testGetAnglesObjet() {
        ...
        pixel.getAngles(o);
        ArrayList<Double> angles = pixel.getAngles();
        //Vérification de la taille de l'ArrayList.
    ...
    void testGetAnglesBarycentre() {
        ...
        //Calcul de l'angle entre un pixel ou point et le centre de gravité.
