...
class ObjetTest {
    ...
    public void testAddColor() {
        ...
        Objet obj = new Objet();
        obj.addColor(255);
        //Vérifie qu'on obtient bien la couleur qu'il faut.
    ...
    public void testRetourCentreGravite() {
        //Création d'un objet avec des données de test.
        Objet objet = new Objet();
        Pixel centreGraviteAttendu = new Pixel(10, 20, 255);
        objet.setCentreGravite(centreGraviteAttendu);

        //Vérifie que la méthode retourCentreGravite() retourne le centre de gravité attendu.
    ...
    public void testRetourCentreGraviteY() {
        //Création un objet avec des données de test.
        Objet objet = new Objet();
        Pixel centreGraviteAttendu = new Pixel(10, 20, 255);
        objet.setCentreGravite(centreGraviteAttendu);
    ...
    public void testCalculAngles() {
        ...
        //Vérifie que les angles ont été calculés.
        for (Pixel pixel : objA.retourneEnsemblePoints()){assertNotNull(pixel.getAngles());}
    }
    ...
    void testAfficherCentreGravite() {
        ...
        objet.retourneEnsemblePoints().add(p1);
        objet.getColor();
        //Création des dimensions de l'image.
        int width = 100;
        int height = 100;
    ...
    void testGetAngleTop() {
        ...
        //Assert pour verifier le bon résultat attendu.
