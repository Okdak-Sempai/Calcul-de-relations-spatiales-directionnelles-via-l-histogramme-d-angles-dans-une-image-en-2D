    ...
    public static void main(String[] args)
    {
        ...
        if (args.length==3)
        {
            try {
                ...
                //On vérifie si le deuxième argument vaut 1 ou 2 pour le choix de l'objet.
                if (Integer.parseInt(args[1]) != 1 && Integer.parseInt(args[1]) != 2)
                {
                    throw new Exception("Le choix doit être 1 ou 2.");
                }
        ...
        try {
                            ...
                            if (fileName.endsWith(".png")) {  
                                ...
                                for (int x = 0; x < image.getWidth(); x++) {
                                    for (int y = 0; y < image.getHeight(); y++) {
                                        ...
                                        //Si le pixel n'est ni jaune, ni vert, ni violet on affiche un message d'erreur
            ...
            //Réitération de la boucle while tant que l'utilisateur choisi la valeur 'o' ou 'O' pour choixContinuer et que la valeur booléenne continuer vaut true.
            while(continuer) {
                int choixCouleur;
                ...
                else //Version GUI.
                {
                    ...
                    while (true) {
                        ...
                        if (sc1.hasNextInt()) {
                            ...
                            sc1.next();//Permet de traiter tous les cas d'erreur. (Saisi d'un mauvais entier, d'un caractère ou d'une chaine de caractère.)
                        }
                        System.out.println("\n");
                ...
                //L'entier entré doit obligatoirement être entre 0 et 360 pour le choix de la méthode : 0 = barycentre ou [1,360] = paires de points.
                int choixMethode;
                if (args.length != 0) //Version ligne de commande.
                {
                ...
                //On sort si on passe par la ligne de commande.
                if(args.length!=0){System.exit((0));}

                //Demande à l'utilisateur s'il souhaite continuer ou quitter.
                System.out.println();
                System.out.println("Souhaitez-vous continuer ? [O] pour Oui ou [N] pour non ?");
                char choixContinuer = ' ';
                while (args.length==0) {
                    Scanner sc3 = new Scanner(System.in);
                    String input = sc3.nextLine().trim();
                    //Permet de traiter tous les cas d'erreur.(Saisi d'un mauvais caractère ou d'une chaine de caractère.)
                ...
                //Si l'utilisateur saisi 'n' ou 'N' on sort de la boucle while et on quitte l'application.
